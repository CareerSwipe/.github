...
3. [Database Schema](#database-schema)
    - [users](#1-users)
    - [candidate_profiles](#2-candidate_profiles)
    - [candidate_skills](#3-candidate_skills)
    - [candidate_wanted_positions](#4-candidate_wanted_positions)
    - [candidate_wanted_locations](#5-candidate_wanted_locations)
    - [candidate_experiences](#6-candidate_experiences)
    - [candidate_education](#7-candidate_education)
    - [candidate_certificates](#8-candidate_certificates)
    - [candidate_projects](#9-candidate_projects)
    - [candidate_achievements](#10-candidate_achievements)
    - [candidate_languages](#11-candidate_languages)
    - [candidate_desired_seniority](#12-candidate_desired_seniority)
    - [companies](#13-companies)
    - [recruiter_profiles](#14-recruiter_profiles)
    - [jobs](#15-jobs)
    - [job_skills](#16-job_skills)
4. [Swipe & Matching Tables](#swipe--matching-tables)
    - [candidate_swipes](#17-candidate_swipes)
    - [recruiter_swipes](#18-recruiter_swipes)
    - [card_locks](#19-card_locks)
    - [matches](#20-matches)
5. [Chat & Communication Tables](#chat--communication-tables)
    - [conversations](#21-conversations)
    - [messages](#22-messages)
6. [Recommendation Algorithm Tables](#recommendation-algorithm-tables)
    - [matching_signals](#23-matching_signals)
    - [match_feedback_events](#24-match_feedback_events)
    - [regional_demand_supply](#25-regional_demand_supply)
7. [Analytics & Audit Tables](#analytics--audit-tables)
    - [user_sessions](#26-user_sessions)
    - [audit_logs](#27-audit_logs)
    - [swipe_analytics](#28-swipe_analytics)
8. [Future-Proofing Tables](#future-proofing-tables-not-mvp)
    - [premium_features](#29-premium_features-future)
    - [user_premium_features](#30-user_premium_features-future)
    - [scheduled_interviews](#31-scheduled_interviews-future)
    - [starred_jobs](#32-starred_jobs-future---premium)
    - [match_history_archive](#33-match_history_archive-future---premium)
9. [Key Relationships Summary](#key-relationships-summary)
    - [One-to-One Relationships](#one-to-one-relationships)
    - [One-to-Many Relationships](#one-to-many-relationships)
    - [Many-to-Many Relationships](#many-to-many-relationships-via-junction-tables)
10. [Database Design Principles](#database-design-principles)
    ...
    - [Data Integrity](#4-data-integrity)
    - [Security & Compliance](#5-security--compliance)
...
11. [Critical Business Logic Enforced by Schema](#critical-business-logic-enforced-by-schema)
    ...
    - [Algorithm Intelligence](#algorithm-intelligence)
12. [Migration Strategy](#migration-strategy)
    - [Phase 1: MVP Core (Immediate)](#phase-1-mvp-core-immediate)
    - [Phase 2: Algorithm Enhancement (Post-MVP)](#phase-2-algorithm-enhancement-post-mvp)
    - [Phase 3: Premium Features (Future)](#phase-3-premium-features-future)
    - [Phase 4: Company Accounts (Future)](#phase-4-company-accounts-future)
13. [Technical Implementation Notes](#technical-implementation-notes)
    - [Technologies](#technologies)
    - [Critical Queries to Optimize](#critical-queries-to-optimize)
    - [Data Retention Policies](#data-retention-policies)
14. [API Endpoint Design](#api-endpoint-design-rest-over-https)
    - [Conventions](#conventions)
    - [Problem+JSON Error](#problemjson-error)
    - [Auth & Session](#auth--session)
    - [Users](#users)
    - [Candidate Profiles](#candidate-profiles)
    - [Recruiters & Jobs](#recruiters--jobs)
    - [Swipe & Matching](#swipe--matching)
    - [Card Locks](#card-locks-realtime-safety)
    - [Chat](#chat)
    - [Discovery & Explainability](#discovery--explainability)
    - [Admin](#admin-futureflagged-hide-in-prod-until-ready)
...
16. [Matching Algorithm Specification](#matching-algorithm-specification-mvp--v1)
    - [MVP Heuristic Scoring](#mvp-heuristic-scoring)
    - [Exploration/Exploitation](#explorationexploitation)
    - [Learning Loop](#learning-loop-v1)
    - [Explainability API](#explainability-api)
17. [UI/UX Wireframes](#uiux-wireframes-textual-blueprint)
    - [Login / Registration](#login--registration)
    - [Main Swipe View (Candidate)](#main-swipe-view-candidate)
    - [Main Swipe View (Recruiter)](#main-swipe-view-recruiter)
    - [Matches View](#matches-view)
    - [Chat View](#chat-view)
    - [Job Creation/Edit](#job-creationedit)
18. [Real-Time Architecture](#realtime-architecture-websocket)
    - [Connection](#connection)
    - [Events (JSON, envelope)](#events-json-envelope)
    - [Backpressure & QoS](#backpressure--qos)
19. [Video Integration](#video-integration-youtube--s3-fallback)
    - [Candidate/Job 30s Video](#candidatejob-30s-video)
    - [Privacy & Abuse](#privacy--abuse)
